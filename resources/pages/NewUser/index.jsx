...
function NewUser() {
  ...
  return <Form style={style.divBody}>
    <div>
      <h1 className="fs-2" >کاربر جدید</h1>
      <p style={style.p} className="fs-4">مدیریت/کاربران/کاربر جدید</p>
    </div>
    ...
    <div className="w-100 d-flex justify-content-around align-items-center mt-4 gap-5">
      ...
      <div className="w-20">
        ...
        <label className="fs-14" htmlFor="gender">تاریخ تولد</label>
        <DatePicker onChange={(e)=>{setBirthday(e.value)}}/>
        </div>
      </div>

      <div className="w-20">
        <div className="content d-flex flex-column">
          <label className="fs-14" htmlFor="gender">جنسیت</label>
          <RSSelect
            options={[
                { value: "0", label: "زن" },
                { value: "1", label: "مرد" },
    ...
    <div className="w-100 d-flex justify-content-around align-items-center mt-4 gap-5">
      <div className="w-20">
        <div className="content d-flex flex-column">
          <label className="fs-14" htmlFor="select2">وضعیت تاهل</label>
          <RSSelect
            options={[
              { value: "0", label: "مجرد" },
              { value: "1", label: "متاهل" },
      ...
      <div className="w-20">
        <div className="content d-flex flex-column">
          <label className="fs-14" htmlFor="select3">وضعیت شغلی</label>
          <RSSelect
            options={[
              { value: "دانشجو", label: "دانشجو" },
              { value: "شاغل", label: "شاغل" },
              { value: "بیکار", label: "بیکار" },
            ]}
      ...
      <div className="w-20">
        <div className="content d-flex flex-column">
          <label className="fs-14" htmlFor="select3">محل اشتغال</label>
          <RSSelect
            options={[
      ...
      <div className="w-20">
        <div className="content d-flex flex-column">
          <label className="fs-14" htmlFor="select3">وضعیت تحصیلی</label>
          <RSSelect
            options={[
    ...
    <div className="w-100 d-flex justify-content-around align-items-center mt-4 gap-5">
      ...
      <div className="w-50">
        <label className="fs-14 mb-2" htmlFor="profile">تصویر پروفایل</label>
        <Dropzone onDrop={acceptedFiles => {
          setFile(acceptedFiles[0])}}>
          {({ getRootProps, getInputProps }) => (
              <div {...getRootProps()} style={style.dropzoneStyle} className="w-100">
               
                  <div htmlFor="formFile" className="form-lable-profile form-label h-100 w-100 d-flex align-items-center justify-content-center">{
                      file?.name ? file.name : <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="#00B1D6"  fillOpacity= "0.3" className="bi bi-image" viewBox="0 0 16 16">
                      <path d="M6.002 5.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z"/>
                      <path d="M2.002 1a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2h-12zm12 1a1 1 0 0 1 1 1v6.5l-3.777-1.947a.5.5 0 0 0-.577.093l-3.71 3.71-2.66-1.772a.5.5 0 0 0-.63.062L1.002 12V3a1 1 0 0 1 1-1h12z"/>
                    </svg>
                  }</div>
                  <input {...getInputProps()} className="form-control" type="file" id="formFile" />
              </div>
          )}
        </Dropzone>
      </div>
    ...
    <div className="d-flex algin-items-center mt-4 gap-4">
      <Button style={{backgroundColor: "#18C4A5"}} type="submit" onClick={handleSubmitForm}>
        ذخیره
      </Button> 

      <Button style={{backgroundColor: "#FF3464"}} type="submit" onClick={handleDeleteForm}>
        پاک کردن
      </Button>
    </div>
